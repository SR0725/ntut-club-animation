<template>
  <div class="bg d-flex align-start justify-start">
    <span>{{showString.substr(0,4)}}</span>
    <span style="position: relative;">{{showString.substr(4,3)}}
      <div
      class="decText Down"
  ...
  export default {
    ...
    data() {
      return {
        ...
        turnLeft: 0,
        turnRotate: 0,
        mainString: "我們將用最簡單的方式",
        decString: "莪門江甩取間禪勺放戈",
        showString: "",
